    ...
    <div class="row">
        <div class="container">
            <div class="container">
                ...
                <div class="radio">
                    <a href="#" class="active" id="card-transfer"><label><input type="radio" name="optradio">Card transfer</label></a>
                </div>
                <div class="radio">
                    <a href="#" id="account-transfer"><label><input type="radio" name="optradio">Account transfer</label></a>
                </div>
